...
func (x *MovieDeatails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MovieDeatails) ProtoMessage() {}

func (x *MovieDeatails) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MovieDeatails.ProtoReflect.Descriptor instead.
func (*MovieDeatails) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{1}
}

func (x *MovieDeatails) GetRating() float32 {
	if x != nil {
		return x.Rating
	}
	return 0
...
func (x *MovieDeatails) GetMetadata() *Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_movie_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x4e, 0x0a,
	0x0d, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x44, 0x65, 0x61, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x16,
	...
	0x61, 0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x17, 0x5a,
	0x15, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_movie_proto_goTypes = []interface{}{
	...
	(*MovieDeatails)(nil), // 1: MovieDeatails
}
var file_movie_proto_depIdxs = []int32{
	0, // 0: MovieDeatails.metadata:type_name -> Metadata
