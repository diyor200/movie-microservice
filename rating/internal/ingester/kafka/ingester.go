...
type Ingester struct {
	// consumer kafka.Consumer - kitob bo'yicha xatolik bo'ldi.
	consumer *kafka.Consumer // pointer qo'yi xatolikni to'rilafdim.
	topic    string
}
...
// Ingest starts to ingestion from Kafka and returns a channel containing rating
// events repsesenting the data consumed from the topic.
